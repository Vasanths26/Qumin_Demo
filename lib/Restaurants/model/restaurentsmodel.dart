...
class Restaurents {
  ...
  factory Restaurents.fromRawJson(String str) =>
      Restaurents.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory Restaurents.fromJson(Map<String, dynamic> json) => Restaurents(
...
class MenuItem {
  ...
  final bool dinner;
  final int heatIndex;
  final CategoryNameEnum category;
  final Tax tax;
  ...
  factory MenuItem.fromJson(Map<String, dynamic> json) => MenuItem(
        ...
        category: categoryNameEnumValues.map[json["category"]]!,
        ...
        curationId: List<String>.from(json["curation_id"].map((x) => x)),
      );
...
class TotalCalories {
  ...
  factory TotalCalories.fromJson(Map<String, dynamic> json) => TotalCalories(
        unit: totalCaloriesUnitValues.map[json["unit"]]!,
        value: json["value"]?.toDouble(),
      );
...
class RestaurantDetails {
  ...
  factory RestaurantDetails.fromJson(Map<String, dynamic> json) =>
      RestaurantDetails(
        id: json["id"],
        name: restaurantNameEnumValues.map[json["name"]]!,
        hotelId: json["hotel_id"],
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "name": restaurantNameEnumValues.reverse[name],
        "hotel_id": hotelId,
